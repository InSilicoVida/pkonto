 ...
 * [pko.yml](pko.yml)
     * Determines how your purl.obolibrary.org/obo/pko/ redirects will be handled
     ...
     * Paste in the contents of [pko.yml](pko.yml)
 ...
 * [pko.md](pko.md)
     ...
     * Paste in the contents of [pko.md](pko.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
